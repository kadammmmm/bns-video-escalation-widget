...
export declare class ModuleGeneralNotifications {
    ...
    isAiAssistantNotificationsEnabled: boolean;
    ...
    getNotificationType(r: Notifications.ItemMeta.Raw): string | undefined;
    fire(raw: Notifications.ItemMeta.Raw | Notifications.ItemMeta.Raw[]): Notifications.Item[] | undefined;
    fireNewChatMessage(data: Utility.MediaDetails, type: string, iconUrl: string | undefined, taskId: string): void;
    ...
    updateNotificationSettings(isNotificationsEnabled: boolean, isAiAssistantNotificationsEnabled: boolean, isSilentNotificationsEnabled: boolean): void;
    updateConfig(toasterTimer?: number, maximumToasterCount?: number): void;
    triggerPresenceNotification(callingValue: string, retryCallback?: {
        (): Promise<void>;
        (): void;
    } | undefined): void;
    getPresenceNotifData: (titleType: string, retryCallback?: {
        (): Promise<void>;
        (): void;
    } | undefined) => {
        notificationType: Notifications.ItemMeta.Type.Error | Notifications.ItemMeta.Type.Success;
        notificationTitle: string;
        notificationData: ToasterNotificationItemContent.DataController;
