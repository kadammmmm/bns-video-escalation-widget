...
export declare class ModuleAgent extends UserStore {
    ...
    lcmUrl: string;
    teamUniqueId: string;
    dialPlan: import("@/../../agentx-services/dist/types/src/services/aqm/types/aqm-service-configs.types").DialPlan;
    outDialEp: string;
    ...
    subStatusChangeTimestamp: Date | null;
    idleStatusTimestamp: Date | null;
    ...
    handleStatusUpdateWithIdleCode: (agentState: string, auxCodeId: string, lastStateChangeTimestamp: number, lastIdleCodeChangeTimestamp: number, fetchedSingleIdleCode?: undefined) => void;
    ...
    get getIsPersonalGreetingsEnabledInProfile(): boolean;
    updateStatusAfterRONA(newState: string): void;
    updateSubStatus(subStatus: Service.Aqm.Agent.StateChange["state"], lastStateChangeTimestamp: number | undefined, lastIdleCodeChangeTimestamp: number | undefined): void;
    ...
    updateMediaPermission(status: PermissionState): Promise<void>;
    ...
    updateAgentMe(meData: CI.User, isCxStudioAdminFlowEnabled?: boolean): void;
