...
export declare function listenForUserPreferencesSavedError(): IReactionDisposer;
...
export declare const isCustomerRelatedReasonCode: (reasonCode: number | string) => boolean;
...
export declare const getErrorMsgForReasonCode: (reasonCode: string | number | undefined, failureEventName?: string) => string | null;
 ...
 * @param event
 */
export declare function checkAgentLogout(event: Service.Aqm.Agent.LogoutSuccess["data"] | {
    loggedOutBy: string;
}): void;
export declare const getRonareason: (reasonCode: number, interaction: Service.Aqm.Contact.AgentContact["data"]["interaction"], failureEventName?: string | undefined) => import("lit-element").TemplateResult;
export declare function ronaToOtherState(interaction: Service.Aqm.Contact.AgentContact["data"]["interaction"], reasonCode: any, failureEventName?: string): void;
...
export declare function inviteFailedToIdle(interaction: Service.Aqm.Contact.AgentContact["data"]["interaction"], trackingId: string, reasonCode?: string | number | undefined, failureEventName?: string): void;
...
export declare const handleInteractionNavigateActiveTab: (event: Event) => void;
...
/**
 * Checks if the current user is in CX Studio admin flow mode
 * @returns {boolean} true if CX Studio admin flow is enabled AND user has EXTERNAL_FULL_ADMIN role
 */
export declare function isCxStudioAdminFlowActive(): boolean;
/**
 * Checks if the Flows feature is enabled for the current user
 * @returns {boolean} true if CX Studio flow listing is enabled AND user has EXTERNAL_FULL_ADMIN role
 */
export declare function isFlowsViewEnabled(): boolean;
export declare function isPersonalGreetingsEnabled(): boolean;
export declare function isQueueStatsTabEnabled(): boolean;
export declare function isConfigurationsManagerViewEnabled(): boolean;
export declare function isSchedulingViewEnabled(): boolean;
...
export declare const shouldRequestRealTimeTranscripts: (interaction: Service.Aqm.Contact.AgentContact["data"]["interaction"], checkMediaForked?: boolean) => boolean;
...
export declare const handleParticipantLeaving: (agentId: string, orgId: string, interaction: Service.Aqm.Contact.AgentContact["data"]["interaction"]) => void;
export declare function updateOrgSettings(): Promise<void>;
export declare function isAnyAiFeatureEnabled(): boolean;
