export declare namespace RTDTypes {
    ...
    type AgentDetailsForNewTPW = {
        agentId: string;
        agentName: string;
        agentEmail?: string;
        orgId?: string;
        phoneNumber: string;
        voiceChannelDetails?: ChannelDetails;
        chatChannelDetails?: ChannelDetails;
        emailChannelDetails?: ChannelDetails;
        socialChannelDetails?: ChannelDetails;
        ...
        actions?: SupervisorActionStatus;
        agentNameDetails?: AgentNameDetails;
    };
    type SupervisorActionStatus = {
        agentName: string;
        agentEmail?: string;
        agentId: string;
    ...
    type AgentChannelTypeStatus = RTD<{
        orgId: string;
        agentId: string;
        agentName: string;
        agentEmail: string;
    ...
    type AgentChannelStatistics = RTD<{
        teamId: string;
        orgId: string;
        agentId: string;
        siteId: string;
        ...
        eventTime: number;
        channelType: string;
        totalContactsHandledCount: number;
        totalConnectedCount: number;
        totalConnectedDuration: number;
        totalHoldCount: number;
        totalHoldDuration: number;
        totalConsultAnswerCount: number;
        totalConsultAnswerDuration: number;
        totalConsultRequestCount: number;
        totalConsultRequestDuration: number;
        totalConferenceCount: number;
        totalConferenceDuration: number;
        totalWrapupCount: number;
        totalWrapupDuration: number;
        totalNotRespondedCount: number;
        totalNotRespondedDuration: number;
        eventKey: string;
        totalChannelCount: number;
        availableChannelCount: number;
        selfPickedCount: number;
        manualAssignmentChannelLimit?: number;
    }>;
    type ChannelStatisticDetails = {
        automaticallyAssigned?: number;
        totalChannelCount?: number;
        selfAssigned?: number;
        manualAssignmentChannelLimit?: number;
    };
    type AgentChannelStatisticsForNewTPW = {
        voiceChannelDetails: ChannelStatisticDetails;
        chatChannelDetails: ChannelStatisticDetails;
        emailChannelDetails: ChannelStatisticDetails;
        socialChannelDetails: ChannelStatisticDetails;
    };
    type RTD<T = any> = {
        key: string;
        operation: string;
    ...
    type AgentContactStats = RTD<{
        ...
        requiredSkills: Skill[] | null;
        matchedSkills: Skill[] | null;
