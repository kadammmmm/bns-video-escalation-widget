...
export declare enum UserProfileAccess {
    ENABLED = "ENABLED",
    DISABLED = "DISABLED",
    EDIT = "EDIT",
    VIEW = "VIEW",
...
export type AccessLevel = "SPECIFIC" | "ALL";
export type UserProfileV3Response = {
    organizationId: string;
    id: string;
    version: number;
    name: string;
    ...
    viewableFolderIds: string[];
    nonViewableFolderIds: string[];
