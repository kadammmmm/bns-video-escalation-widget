...
export declare function cmsService(): {
    ...
    fetchOrgLevelQueuesByPage: (p: {
        ...
        provisioningView?: boolean | undefined;
    ...
    fetchUserProfileV3: (p: {
        profileId: string;
        orgId: string;
    }, cb?: ((res: any) => void | CmsServiceTypes.UserProfileV3Response) | undefined) => Promise<CmsServiceTypes.UserProfileV3Response>;
    ...
    fetchSystemDefaultEntryPoint: (p: {
        orgId: string;
    }, cb?: ((res: any) => void | CmsServiceTypes.EntryPointsResponse) | undefined) => Promise<CmsServiceTypes.EntryPointsResponse>;
    ...
    fetchAllManagedTeams: (orgId: string, provisioningView?: boolean) => Promise<Cms.ManagedAllTeamResponse>;
    fetchAllManagedQueues: (orgId: string, provisioningView?: boolean) => Promise<Cms.ManagedAllQueueResponse>;
    ...
    fetchAgentGreetings: (p: {
        orgId: string;
    }, cb?: ((res: any) => void | CmsServiceTypes.AgentGreetingsResponseData) | undefined) => Promise<CmsServiceTypes.AgentGreetingsResponseData>;
    fetchAllGreetingsPurposesForOrg: (p: {
        orgId: string;
    }, cb?: ((res: any) => void | CmsServiceTypes.GreetingsPurposesForOrgResponseData) | undefined) => Promise<CmsServiceTypes.GreetingsPurposesForOrgResponseData>;
    deleteGreetingById: (p: {
        orgId: string;
        greetingId: string;
    }, cb?: ((res: any) => void | Cms.NoContentResponse) | undefined) => Promise<Cms.NoContentResponse>;
    getGreetingPresignedUrl: (p: {
        orgId: string;
        greetingId: string;
    }, cb?: ((res: any) => void | CmsServiceTypes.AllPurposes) | undefined) => Promise<CmsServiceTypes.AllPurposes>;
};
...
declare module "../../index" {
    namespace Service.Cms {
        ...
        type PurposesData = CmsServiceTypes.PurposesData;
        ...
        type EntryPointsResponseDataForCallback = {
            meta: {
                ...
                totalPages: number;
                totalRecords: number;
                callbackEnabledEntryPointId: string;
            };
        ...
        type UserProfilePermission = CmsServiceTypes.UserProfilePermission;
        ...
        type UserProfileV3Response = CmsServiceTypes.UserProfileV3Response;
        ...
        type AgentGreetingsResponseData = CmsServiceTypes.AgentGreetingsResponseData;
        type GreetingsPurposesForOrgResponseData = CmsServiceTypes.GreetingsPurposesForOrgResponseData;
        type GreetingWithPresignedUrlResponseData = CmsServiceTypes.AllPurposes;
    }
}
export {};
