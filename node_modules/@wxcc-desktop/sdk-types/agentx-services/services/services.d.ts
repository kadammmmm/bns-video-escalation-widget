...
import { CcaiService } from "./ccai/ccai-service";
import { cmsService } from "./cms/cms-service";
import { ConfService } from "./conf/conf-service";
import { constant } from "./constant";
import { DataNotifsService } from "./data-notifs/data-notifs-service";
...
export declare class AgentxServices {
    ...
    isIniting: boolean;
    isInited: boolean;
    init(token: OAuth.Token, oauthConfig: OAuth.Config, webexInstance: unknown): Promise<void>;
}
