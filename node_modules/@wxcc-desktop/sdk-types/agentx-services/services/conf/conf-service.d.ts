...
export declare class ConfService {
    ...
    fetchProfile(orgId?: string, userId?: string, isSupervisor?: boolean, persona?: string): Promise<Service.Conf.Profile>;
