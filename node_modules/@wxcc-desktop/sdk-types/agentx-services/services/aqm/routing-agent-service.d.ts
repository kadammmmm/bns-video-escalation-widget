...
export declare function routingAgent(routing: AqmReqs): {
    reload: import("../../core/aqm-reqs").ResEmpty<Agent.ReloginSuccess | Agent.AgentChannelReloginSuccess>;
    ...
    eAgentChannelReloginSuccess: import("@uuip/unified-ui-platform-sdk").Signal.WithData<Agent.AgentChannelReloginSuccess> & {
        listenOnceAsync: (p?: {
            resolveIf?: ((msg: Agent.AgentChannelReloginSuccess) => boolean) | undefined;
            timeout?: import("../../core/aqm-reqs").Timeout | undefined;
        } | undefined) => Promise<Agent.AgentChannelReloginSuccess>;
    };
...
declare module "../../index" {
    namespace Service.Aqm.Agent {
        ...
        type AgentChannelReloginSuccess = Msg<{
            agentId: string;
            orgId: string;
            status?: string;
            dn: string;
        ...
        type ReloginSuccess = Msg<{
            ...
            profileType: string;
            channelsMap: Record<string, string[]>;
            agentChannelStateDetailMap?: Record<Service.Aqm.Configs.Channels, Service.Aqm.Configs.AgentChannelTypeStates>;
            dialNumber?: string;
            roles?: string[];
            deviceType?: DeviceType;
            deviceId?: string | null;
