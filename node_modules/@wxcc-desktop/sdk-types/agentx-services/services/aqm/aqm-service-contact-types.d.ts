...
type contactErrorIds = {
    ...
    "Service.aqm.contact.recordPersonalGreeting": Failure;
};
...
declare module "../../index" {
    namespace Service.Aqm.Contact {
        ...
        type PersonalGreetingCallData = {
            ...
            customAttributes: {};
            flowSettings: {
                greetingPurpose: string;
                greetingPurposeId: string;
                agentPersonalGreetingId: string;
            };
        };
    }
}
