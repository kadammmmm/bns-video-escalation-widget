...
import { AqmNotifs, WSStatus } from "../../core/aqm-notifs";
...
import { aqmAiAssistant } from "./ai-assistant-events";
...
export declare class AqmService {
    ...
    constructor(accessToken: string, organizationId: string, init: (p: () => Promise<void>) => void, useWebsocketInWebworker: boolean, autoResolveAfterDelay: boolean, useLegacyReconnect: boolean, aqmNotifs: AqmNotifs);
    getWebsocketStatus(): Service.Aqm.Connection.ConnectionLostDetails | WSStatus;
