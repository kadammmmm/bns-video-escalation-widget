...
type Listeners = {
    ...
    eAgentChannelStateChanged: Parameters<AgentxService["aqm"]["agent"]["eAgentChannelStateChanged"]["listen"]>[0];
    eAgentChannelReloginSuccess: Parameters<AgentxService["aqm"]["agent"]["eAgentChannelReloginSuccess"]["listen"]>[0];
};
...
export declare class AgentStateInfoJsapi {
    ...
    stateChangeV2(stateData: Service.Aqm.Agent.StateChangeV2): Promise<Service.Aqm.Agent.AgentChannelStateChanged | undefined>;
