...
type Listeners = {
    ...
    eSuggestedResponseAcknowledgeEvent: Parameters<AgentxService["aqm"]["aiAssistant"]["eSuggestedResponseAcknowledgeEvent"]["listen"]>[0];
    eSuggestedResponseEnablementEvent: Parameters<AgentxService["aqm"]["aiAssistant"]["eSuggestedResponseEnablementEvent"]["listen"]>[0];
    eMidCallSummaryResponseSubsequentAgent: Parameters<AgentxService["aqm"]["aiAssistant"]["eMidCallSummaryResponseSubsequentAgent"]["listen"]>[0];
